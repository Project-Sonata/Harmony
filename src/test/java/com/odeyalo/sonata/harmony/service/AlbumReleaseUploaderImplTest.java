...
public class AlbumReleaseUploaderImplTest {
    ...
    void setUp() {
        ...
        ArtistContainerEntityConverter converter = new Converters().artistContainerEntityConverter();

        testable = new AlbumReleaseUploaderImpl(albumRepository, steps, converter);
